	...
	{ 
		...
		//Drop the control frames
		std::string interface;
		interface = "can0";
		ctre::phoenix::platform::can::SetCANInterface(interface.c_str());
		std::cout << "Interface created";
		
		int devIdBetween0And62 = 0;
		int32_t status = 0;
		uint32_t messageID = 0x02040080 | devIdBetween0And62;
		ctre::phoenix::platform::can::CANComm_SendMessage(messageID, 0, 0, 0, &status);
